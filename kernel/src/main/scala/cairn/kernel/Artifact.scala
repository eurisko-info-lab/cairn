...
enum ArtifactKind(val name: String):
  ...
  case ProofGoal      extends ArtifactKind("proof-goal")
  ...
  case ProjectionEvidence extends ArtifactKind("projection-evidence")
  ...
  case WorkspaceDraft extends ArtifactKind("workspace-draft")
  case WorkspaceReview extends ArtifactKind("workspace-review")
  case WorkspaceApproval extends ArtifactKind("workspace-approval")
  case WorkspaceHandoff extends ArtifactKind("workspace-handoff")
